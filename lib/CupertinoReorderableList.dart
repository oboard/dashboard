...
/// The callback used by [CupertinoReorderableListView] to move an item to a new
/// position in a list.
///
...
/// [CupertinoReorderableListView] will need to account for this when inserting before
/// [newIndex].
///
...
class CupertinoReorderableListView extends StatefulWidget {
  ...
  /// underlying list.
  ///
  /// This [CupertinoReorderableListView] calls [onReorder] after a list child is dropped
  /// into a new position.
  final ReorderCallback onReorder;

  @override
  _CupertinoReorderableListViewState createState() =>
      _CupertinoReorderableListViewState();
}

// This top-level state manages an Overlay that contains the list and
// also any Draggables it creates.
//
// _CupertinoReorderableListContent manages the list itself and reorder operations.
//
...
// That overlay entry then builds a _CupertinoReorderableListContent which may
// insert Draggables into the Overlay above itself.
class _CupertinoReorderableListViewState
    extends State<CupertinoReorderableListView> {
  ...
  final GlobalKey _overlayKey =
      GlobalKey(debugLabel: '$CupertinoReorderableListView overlay key');
  ...
  void initState() {
    ...
    _listOverlayEntry = OverlayEntry(
      ...
      builder: (BuildContext context) {
        return _CupertinoReorderableListContent(
...
// CupertinoReorderableListView.
class _CupertinoReorderableListContent extends StatefulWidget {
  const _CupertinoReorderableListContent({
  ...
  @override
  _CupertinoReorderableListContentState createState() =>
      _CupertinoReorderableListContentState();
}

class _CupertinoReorderableListContentState
    extends State<_CupertinoReorderableListContent>
    with TickerProviderStateMixin<_CupertinoReorderableListContent> {
  ...
  Widget _wrap(Widget toWrap, int index, BoxConstraints constraints) {
    ...
    final _ScopedValueGlobalKey<_CupertinoReorderableListContentState>
        keyIndexGlobalKey =
        _ScopedValueGlobalKey<_CupertinoReorderableListContentState>(
      scope: this,
      value: toWrap.key,
    );
    ...
    Widget buildDragTarget(BuildContext context, List<Key> acceptedCandidates,
      ...
      Widget child = LongPressDraggable<Key>(
        ...
        feedback: Container(
          ...
          child: Transform.scale(scale: 1.01, child: toWrapWithSemantics),
        ),
...
class _ScopedValueGlobalKey<T extends State<StatefulWidget>>
    extends GlobalKey<T> {
