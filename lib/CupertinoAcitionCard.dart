...
/// provide [CupertinoActionCardAction]s for the [actions] given to this action sheet.
///
/// To include a iOS-style cancel button separate from the other buttons,
/// provide an [CupertinoActionCardAction] for the [cancelButton] given to this
/// action sheet.
///
...
/// See also:
///
///  * [CupertinoActionCardAction], which is an iOS-style action sheet button.
///  * <https://developer.apple.com/design/human-interface-guidelines/ios/views/action-sheets/>
class CupertinoActionCard extends StatelessWidget {
  ...
  ///
  /// Typically this is a list of [CupertinoActionCardAction] widgets.
  ...
  /// actions.
  ///
  /// Typically this is an [CupertinoActionCardAction] widget.
...
/// A button typically used in a [CupertinoActionCard].
///
/// See also:
///
///  * [CupertinoActionCard], an alert that presents the user with a set of two or
///    more choices related to the current context.
class CupertinoActionCardAction extends StatelessWidget {
  /// Creates an action for an iOS-style action sheet.
  ///
  /// The [child] and [onPressed] arguments must not be null.
  const CupertinoActionCardAction({
...
// The "content section" of a CupertinoActionCard.
//
...
// The "actions section" of a CupertinoActionCard.
//
